...
function getProperties(fixtureGroup, _data, options){
  var rawDef, me = this;
  var rawData = fixtures[fixtureGroup][_data] || {};
  if(options){
  ...
  _.each(refs, function(val, key){
    if(_.isUndefined(val.value)){
      setHasMany.call(me, val, key, fixtureGroup, _data);
    } else {
...
function setHasMany(val, key, fixtureGroup, parentFixture){
  var me = this
    , options = {};
  options[key]={
...
TestDataBuilder.prototype.define = function(name, fixtureGroup, data, options) {
  if(typeof data === 'string'){
    this._definitions.push({
      ...
      fixture: fixtureGroup,
      properties: getProperties.call(this, fixtureGroup, data, options)
    });
  } else {
    this._definitions.push({
      name: name,
